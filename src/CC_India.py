...
NIFTY50_SYMBOLS = [
    ...
    "TATAMOTORS","TATASTEEL","TCS","TECHM","TITAN","ULTRACEMCO","WIPRO","CUMMINS",
    "OFSS","BSE","HAL","PERSISTENT","BEL","TATAELXSI","TRENT","COFORGE","MCX"
    ,"BHARATFORG","CGPOWER","BDL","ANGELONE","INDUSTOWER","MPHASIS"
'BANKNIFTY',
'FINNIFTY',
'MIDCPNIFTY',
'NIFTY',
